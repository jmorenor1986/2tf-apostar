...
public enum ErrorEnum {
    ...
    PAQUETE_MOVIL_MANDATORY("Los datos para guardar el paquete movil son obligatorios"),
	NUMERO_IS_MANDATORY ("El número es obligatorio"),
	ID_PAQUETE_IS_MANDATORY("El id del paquete es obligatorio");
